              ...
              <div class="row">
                ...
                <div class="col-lg-4">
                  <div class="main-button">
                    <a rel="nofollow" href="https://templatemo.com/tm-551-stand-blog" target="_blank">Yüklə!</a>
                  </div>
                </div>
              </div>
            </div>
                  ...
                  <div class="blog-post">
                    ...
                    <div class="down-content">
                      ...
                      <ul class="post-info">
                        ...
                        <li><a href="#">May 12, 2022</a></li>
                        <li><a href="#">10 Comment</a></li>
                      </ul>
                    ...
                    <div class="content">
                      <form id="comment" action="#" method="post">
                        <div class="row">
                          ...
                          <div class="col-lg-12">
                            <fieldset>
                              <textarea name="message" rows="6" id="message" placeholder="Kommentinizi yazın" required=""></textarea>
                            </fieldset>
                          </div>
                          <div class="col-lg-12">
                            <fieldset>
              ...
              <div class="row">
                <div class="col-lg-12">
                  <div class="sidebar-item search">
                    <form id="search_form" name="gs" method="GET" action="#">
                      <input type="text" name="q" class="searchText" placeholder="axtarış..." autocomplete="on">
                    </form>
                  </div>
                </div>
                <div class="col-lg-12">
                ...
                <div class="col-lg-12">
                  <div class="sidebar-item tags">
                    ...
                    <div class="content">
                      <ul>
                        <li><a href="#">Həyat Tərzi</a></li>
                        <li><a href="#">Kreativ</a></li>
